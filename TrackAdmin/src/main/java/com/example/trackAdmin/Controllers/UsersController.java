...
public class UsersController {
    ...
    public String login(@RequestParam String email,
        ...
        return "redirect:/error"; // Przekierowanie na stronę logowania z informacją o błędzie
    }

    @GetMapping(path = "/normalUser") //odwoluje sie do pliku html o danej nazwie w naszym przypadku to login.html
