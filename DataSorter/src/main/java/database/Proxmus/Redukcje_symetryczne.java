...
public class Redukcje_symetryczne {

    public static void showTable() {
        JFrame tableFrame = new JFrame("Tabela_Redukcje_Symetryczne");
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT * FROM redukcjie_symetryczne");
        ...
        String FilePath = "Reduckje_symetryczne";
