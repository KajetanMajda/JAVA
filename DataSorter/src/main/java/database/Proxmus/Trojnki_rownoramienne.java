...
public class Trojnki_rownoramienne {
    ...
    public static void showTable() {
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT * FROM trojniki_rownoramienne");
        ...
        String FilePath = "Trojnik_równoramienny_zbiór";
