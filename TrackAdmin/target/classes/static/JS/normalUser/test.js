...
// const divisionSelect = document.getElementById("dzial");
//
// projectSelect.addEventListener("change", updateTableBasedOnSelection);
// divisionSelect.addEventListener("change", updateTableBasedOnSelection);
//
// function updateTableBasedOnSelection() {
//     const selectedProjectId = projectSelect.value;
//     const selectedDivisionId = divisionSelect.value;
//     const filteredElements = filterElements(selectedProjectId, selectedDivisionId);
//     populateTable(filteredElements);
// }
//
//
