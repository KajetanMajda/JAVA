...
public class Mufy {
    ...
    public static void showTable() {
        JFrame tableFrame = new JFrame("Tabela_Muf");
        ...
        try {
            ...
            ResultSet resultSet = statement.executeQuery("SELECT * FROM mufy");
        ...
        copyButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (!selectedFiles.isEmpty()) {
                    try {
                        ListTransferable transferable = new ListTransferable(selectedFiles);
